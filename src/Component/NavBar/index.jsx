        ...
        <div className="justify-items-start">
          <div className="pt-4 flex items-start justify-around ">
            <div className="flex items-start -ms-28">
              ...
              <Link
                to="/"
                className=" bg-white focus:border-transparent cursor-pointer py-1"
              >
...
=======
        ...
        <ul className="justify-items-end w-full h-full  text-black flex justify-center py-3 text-l">
          ...
          <li className="px-8">
            <Link to="/ads/product">Sản Phẩm</Link>
          </li>
          <li className="px-8">
            <Link to="/ads/create">Đăng kí quảng cáo</Link>
          </li>
          <li className="px-8">
            <Link to="/">Tra Cứu Mệnh</Link>
          </li>
          <li className="px-8">
            <Link to="/">Chia sẻ</Link>
          </li>
          <li className="px-8">
            <Link to="/">Fengshui Koi</Link>
          </li>
>>>>>>> NamLa
        </ul>
      </div>
