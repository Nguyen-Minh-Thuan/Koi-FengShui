      ...
      <form className="bg-white bg-opacity-10 p-8 rounded-lg w-full max-w-2xl mx-auto" onSubmit={handleSubmit}>
        <div className="flex justify-between mb-4">
          <div className="w-[48%] flex flex-col">
            ...
            <select id="gender" required className="w-full p-2 rounded bg-white text-black text-center" value={gender} onChange={(e) => setGender(e.target.value)}>
          ...
          <div className="w-[48%] flex flex-col">
            ...
            <input type="date" id="birthdate" required className="w-full p-2 rounded bg-white text-black text-center" placeholder="dd/mm/yyyy" value={birthdate} onChange={(e) => setBirthdate(e.target.value)} />
          </div>
        </div>
